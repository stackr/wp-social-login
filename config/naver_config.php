...
$consumer_key = $hotpack_social_login['naver']['consumer_key'];
$consumer_secret = $hotpack_social_login['naver']['consumer_secret'];
$callback_url = site_url('?hsl_callback=naver');
