<?php
require_once(dirname(dirname(__FILE__)).'/config/google_config.php');
...
class GoogleOAuth{
	...
	public $curl_useragent           = "HotPackOAuth v0.1";
	...
	public function __construct( $client_id = false, $client_secret = false, $redirect_uri='' )
	{
		...
		$this->api_base_url   = "https://www.googleapis.com/plus/v1/";
