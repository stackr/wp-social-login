<?php
require_once(dirname(dirname(__FILE__)).'/config/naver_config.php');
...
class NaverOAuth{
  ...
  function get_user_profile(){
	...
	curl_setopt($ch, CURLOPT_HTTPHEADER, array('Authorization: Bearer '.$this->token->key) );
	...
	$this->userInfo = array(
		...
		'user_email'	=> (string)$xml->response->email ,
  ...
  function getHeader($ch, $header) {
	...
	* Set API URLS
	*/
	function accessTokenURL()  { return 'https://nid.naver.com/naver.oauth?mode=req_acc_token'; }
